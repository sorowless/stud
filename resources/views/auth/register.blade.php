        ...
        <div class="wrap-login100 p-l-50 p-r-50 p-t-40 p-b-48">
            ...
            <form class="login100-form validate-form" method="POST" action="{{ route('register') }}">
                ...
                <div class="wrap-input100 validate-input" data-validate = "Введите имя">
                    <span class="label-input100">{{ __('Имя') }}</span>
                    <input id="name" type="text" placeholder="..." class="input100 @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name">
                    @error('name')
                ...
                <div class="wrap-input100 validate-input" data-validate = "Повторите пароль">
                    <span class="label-input100">{{ __('Подтверждение пароля') }}</span>
                    <input id="password-confirm" type="password" class="input100" name="password_confirmation" placeholder="*************" required autocomplete="new-password">
                    <span class="focus-input100"></span>
                </div>
